...
<div id="wrapper">
				...
				<div class="box-content">
					<div class="statistics-box with-icon">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
								<td><a href="index.php" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse"><?php 
  ...
  ?></h4></a></td>
								...
								<tr>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse">srvwe105</h4></a></td>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse">6</h4></a></td>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse">6</h4></a></td>
								</tr>
								<tr>
