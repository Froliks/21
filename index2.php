...
<div id="wrapper">
					...
					<div class="statistics-box with-icon">
						...
						<table class="table table-bordered">
							<thead>
								...
								<th>CVE</th>
								<th>Рекомендации по устранению CVE</th>
							...
							<tbody>
								...
								<td><a href="index3.php" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse"><?php 
    ...
    $conn->close(); 
  ?></h4></a></td>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse"><?php 
    $conn = mysqli_connect("localhost", "root", "", "mytable"); 
    // Check connection 
    if ($conn->connect_error) { 
    die("Connection failed: " . $conn->connect_error); 
  ...
  ?></h4></a></td>
								...
								<tr>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse">CVE-2015-1728</h4></a></td>
								<td><a href="#" onclick="openbox('box'); return false" ><h4 style="color:red; class="counter text-inverse"><?php 
    $conn = mysqli_connect("localhost", "root", "", "mytable"); 
    // Check connection 
    if ($conn->connect_error) { 
